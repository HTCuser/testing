...
export async function render(root) {
  ...
  root.innerHTML = `
    <div class="grid stat-grid" style="margin-bottom:16px">
      ${statCard('library', 'blue', 'Tài liệu kỹ thuật', c.documents, 'tệp đã nạp', '/thu-vien')}
      ${statCard('equipment', 'teal', 'Thiết bị quản lý', c.equipment, 'thiết bị', '/thiet-bi')}
      ${statCard('operations', 'green', 'Quy trình', c.procedures, 'quy trình', '/van-hanh')}
      ${statCard('incident', 'red', 'Hồ sơ sự cố', c.incidents, 'hồ sơ', '/su-co')}
      ${statCard('forms', 'violet', 'Biểu mẫu phiếu', c.forms, 'biểu mẫu', '/bieu-mau')}
      ${statCard('database', 'amber', 'Đoạn đã lập chỉ mục', c.chunks, 'đoạn', '/cau-hinh')}
    </div>
    ...
    <div class="grid two-col">
      <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <section class="card">
          <div class="card-head">
            <h2 class="card-title">Hồ sơ sự cố cập nhật gần đây</h2>
      ...
      <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <section class="card">
          <div class="card-head">
            ...
            <div class="card-actions">
              <button class="btn btn-sm" data-goto="/thu-vien">Thư viện</button>
            </div>
          </div>
...
function documentRow(item) {
  ...
  return `
    <a class="row-card" href="#/thu-vien/${item.id}" style="padding:12px 14px">
