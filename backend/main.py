...
from .routers import chat, documents, equipment, forms, incidents, procedures, system
...
for module in (system, chat, documents, equipment, procedures, incidents, forms):
