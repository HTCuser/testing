...
FORMS = [
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Máy cắt 220kV ngăn lộ 171", "action": "Cắt máy cắt 220 kV", "note": ""},
    ...
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Dao cách ly 171-1, 171-2", "action": "Đóng dao cách ly hai phía máy cắt", "note": ""},
    ...
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Bơm nước kỹ thuật số 1, 2", "action": "Cắt aptomat nguồn động lực, khoá tủ điều khiển", "note": "Chuyển chế độ về MANUAL"},
    ...
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Phía 220 kV máy biến áp T1", "action": "Kiểm tra không còn điện áp bằng thiết bị thử 220 kV", "note": ""},
    ...
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Máy cắt đầu cực H2", "action": "Cắt máy cắt đầu cực máy phát", "note": "Xác nhận chỉ thị vị trí cắt"},
    ...
    dict(
        ...
        rows=[
            ...
            {"section": "II", "target": "Phanh hãm H2", "action": "Nhả phanh hãm, xác nhận áp lực khí phanh về 0", "note": ""},
