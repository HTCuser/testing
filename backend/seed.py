...
FORMS = [
    dict(
        code="PTT-01", title="Thao tác đưa tổ máy H1 ra sửa chữa",
        form_type="phieu_thao_tac", work_type="Đưa thiết bị ra sửa chữa",
    ...
    dict(
        code="PTT-02", title="Thao tác đưa tổ máy H1 vào vận hành sau sửa chữa",
        form_type="phieu_thao_tac", work_type="Đưa thiết bị vào vận hành",
        equipment_code="H1-TUA",
    ...
    dict(
        code="PCL-01", title="Cô lập hệ thống nước làm mát tổ máy H1",
        form_type="phieu_co_lap", work_type="Đưa thiết bị ra sửa chữa",
    ...
    dict(
        code="PCL-02", title="Cô lập máy biến áp chính T1 để thí nghiệm định kỳ",
        form_type="phieu_co_lap", work_type="Thí nghiệm định kỳ",
        equipment_code="AT1",
